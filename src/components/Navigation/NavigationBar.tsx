...
export function NavigationBar({
  ...
  const getIcon = (iconName?: string) => {
    ...
    const IconComponent = (Icons as unknown as { [key: string]: React.ComponentType<{ className?: string }> })[iconName];
    const IconoirComponent = (IconoirIcons as unknown as { [key: string]: React.ComponentType<{ className?: string }> })[iconName];
              ...
              {primaryItems.map((item, index) => (
                <div key={index} className="relative">
                  <button
                    ...
                    className="flex items-center text-gray-100 px-3 py-2 text-m font-medium hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 focus:ring-offset-black rounded-lg"
                  ...
                  {item.dropdownItems &&
                    ...
                    activeDropdown === index && (
                      <div
                        ...
                        className="fixed left-1/2 -translate-x-1/2 mt-2 w-[80vw] max-w-6xl bg-black/95 backdrop-blur-sm rounded-xl border border-white/30 shadow-xl"
                            ...
                            {item.dropdownItems.map(
                              (dropdownItem, dropdownIndex) => (
                                <a
                                  ...
                                  className={`group flex items-center w-full p-4 m-2 rounded-lg hover:bg-white/5 transition-colors duration-200 opacity-0 focus:outline-none focus:ring-2 focus:ring-primary/50 ${
                                ...
                                (dropdownItem, dropdownIndex) => (
                                  ...
                                  >
                                    ...
                                    <div>
                                      ...
                                      <p className="mt-1 text-sm text-gray-300 group-hover:text-gray-30">
                                        {dropdownItem.description}
                                      </p>
                                    </div>
                                  </a>
